...
//           <input type="submit" className="btn bg-gradient" style={{backgroundColor: "#d3dce8", color: "black", fontWeight: "bold"}} value="Create Account" />
//         </div>
//       </form>
//     </div>
//   )
            ...
            >
                ...
                <div className="d-flex justify-content-center mt-2">
                    <button
                        ...
                        style={{backgroundColor: "#d3dce8", color: "black", fontWeight: "bold"}}
                        disabled={isLoading}
                    >
